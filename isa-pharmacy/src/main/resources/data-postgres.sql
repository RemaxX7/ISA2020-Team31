...
INSERT INTO PHARMACIES (id,name,rate) values (1,'Apoteka Jankovic',4.3);
INSERT INTO PHARMACIES (id,name,rate) values (2,'Apoteka Benu',3.7);
...
INSERT INTO AUTHORITY (name) VALUES (3,'ROLE_PHARMACIST');
